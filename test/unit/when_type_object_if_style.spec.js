...
test('when type object if style - valid schema', () => {
  expect(jsonSchema).toEqual(BASE_SCHEMA)
})

test('when type object if style - valid matching if', () => {
...
test('when type object if style - valid matching otherwise', () => {
...
test('when type object if style - invalid matching any', () => {
